    ...
    private fun clickDatePicker(){
        ...
        with(DatePickerDialog(this,
            { _, selecetdYear, selectedMonth, selectedDay ->
                Toast.makeText(this,"Year $selecetdYear, Month ${selectedMonth + 1}, Day $selectedDay",Toast.LENGTH_SHORT).show()
                ...
                val currentDatesInMinutes=sdf.parse(sdf.format(System.currentTimeMillis())).time /60000

                ageInMinitesTextView.text = (currentDatesInMinutes - selecetedDatesInMinutes).toString()
